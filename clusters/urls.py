...
urlpatterns = patterns('',
    ...
    url(r'^communitymembers/(?P<community_id>\d+)/$', 'clusters.views.community_members', name="community_members"),
    url(r'^newmember/(?P<community_id>\d+)/$', 'clusters.views.new_community_member', name="new_community_member"),
    ...
    url(r'^deletecluster/(?P<cluster_id>\d+)/$', 'clusters.views.delete_cluster', name="delete_cluster"),
    url(r'^deleteclusterconfirmation/(?P<cluster_id>\d+)/$', 'clusters.views.delete_cluster_confirmation', 
        name="delete_cluster_confirmation"),
    ...
    # diagrams
    url(r'^diagrams/(?P<cluster_id>\d+)/$', 'clusters.views.diagrams', name="diagrams"),
    ...
    url(r'^editclusteragents/(?P<cluster_id>\d+)/$', 'clusters.views.edit_cluster_agents', name="edit_cluster_agents"),
    ...
    url(r'^editagenttext/(?P<cluster_id>\d+)/(?P<agent_id>\d+)/$', 'clusters.views.edit_agent_text', name="edit_agent_text"),
