...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FunctionResourceType.price'
        db.add_column('clusters_functionresourcetype', 'price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=2), keep_default=False)

        # Adding field 'FunctionResourceFlow.price'
        db.add_column('clusters_functionresourceflow', 'price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=2), keep_default=False)

        # Adding field 'AgentFunctionResourceType.price'
        db.add_column('clusters_agentfunctionresourcetype', 'price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=2), keep_default=False)

        # Adding field 'AgentResourceType.price'
        db.add_column('clusters_agentresourcetype', 'price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FunctionResourceType.price'
        db.delete_column('clusters_functionresourcetype', 'price')

        # Deleting field 'FunctionResourceFlow.price'
        db.delete_column('clusters_functionresourceflow', 'price')

        # Deleting field 'AgentFunctionResourceType.price'
        db.delete_column('clusters_agentfunctionresourcetype', 'price')

        # Deleting field 'AgentResourceType.price'
        db.delete_column('clusters_agentresourcetype', 'price')
