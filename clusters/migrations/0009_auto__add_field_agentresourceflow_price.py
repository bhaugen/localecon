...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AgentResourceFlow.price'
        db.add_column('clusters_agentresourceflow', 'price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AgentResourceFlow.price'
        db.delete_column('clusters_agentresourceflow', 'price')
