...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cluster.sharing'
        db.add_column('clusters_cluster', 'sharing', self.gf('django.db.models.fields.CharField')(default='private', max_length=12), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Cluster.sharing'
        db.delete_column('clusters_cluster', 'sharing')
