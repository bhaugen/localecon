...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EconomicAgent.description'
        db.add_column('clusters_economicagent', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EconomicAgent.description'
        db.delete_column('clusters_economicagent', 'description')
