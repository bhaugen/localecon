...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClusterAgent'
        db.create_table('clusters_clusteragent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cluster', self.gf('django.db.models.fields.related.ForeignKey')(related_name='agents', to=orm['clusters.Cluster'])),
            ('agent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='clusters', to=orm['clusters.EconomicAgent'])),
        ))
        db.send_create_signal('clusters', ['ClusterAgent'])


    def backwards(self, orm):
        # Deleting model 'ClusterAgent'
        db.delete_table('clusters_clusteragent')
    ...
    models = {
        ...
        'clusters.clusteragent': {
            ...
            'cluster': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'agents'", 'to': "orm['clusters.Cluster']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'clusters.community': {
