...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('clusters_community', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Community.description'
        db.delete_column('clusters_community', 'description')
