...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Cluster.number_description'
        db.delete_column('clusters_cluster', 'number_description')

        # Deleting field 'Cluster.map_url'
        db.delete_column('clusters_cluster', 'map_url')


    def backwards(self, orm):
        
        # Adding field 'Cluster.number_description'
        db.add_column('clusters_cluster', 'number_description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Cluster.map_url'
        db.add_column('clusters_cluster', 'map_url', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
