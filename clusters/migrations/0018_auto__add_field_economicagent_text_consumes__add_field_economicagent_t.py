...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EconomicAgent.text_consumes'
        db.add_column('clusters_economicagent', 'text_consumes',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EconomicAgent.text_produces'
        db.add_column('clusters_economicagent', 'text_produces',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EconomicAgent.text_info_provided_by'
        db.add_column('clusters_economicagent', 'text_info_provided_by',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EconomicAgent.text_contact'
        db.add_column('clusters_economicagent', 'text_contact',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EconomicAgent.text_degree_of_separation'
        db.add_column('clusters_economicagent', 'text_degree_of_separation',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EconomicAgent.text_consumes'
        db.delete_column('clusters_economicagent', 'text_consumes')

        # Deleting field 'EconomicAgent.text_produces'
        db.delete_column('clusters_economicagent', 'text_produces')

        # Deleting field 'EconomicAgent.text_info_provided_by'
        db.delete_column('clusters_economicagent', 'text_info_provided_by')

        # Deleting field 'EconomicAgent.text_contact'
        db.delete_column('clusters_economicagent', 'text_contact')

        # Deleting field 'EconomicAgent.text_degree_of_separation'
        db.delete_column('clusters_economicagent', 'text_degree_of_separation')
    ...
    models = {
        ...
        'clusters.clusteragent': {
            'Meta': {'ordering': "('cluster', 'agent')", 'object_name': 'ClusterAgent'},
            'agent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'clusters'", 'to': "orm['clusters.EconomicAgent']"}),
            'cluster': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cluster_agents'", 'to': "orm['clusters.Cluster']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'clusters.community': {
        ...
        'clusters.economicagent': {
            ...
            'text_consumes': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'text_contact': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'text_degree_of_separation': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'text_info_provided_by': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'text_produces': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'})
        },
