...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Community.when_changed'
        db.alter_column('clusters_community', 'when_changed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

        # Changing field 'Cluster.when_changed'
        db.alter_column('clusters_cluster', 'when_changed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'Community.when_changed'
        db.alter_column('clusters_community', 'when_changed', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

        # Changing field 'Cluster.when_changed'
        db.alter_column('clusters_cluster', 'when_changed', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
