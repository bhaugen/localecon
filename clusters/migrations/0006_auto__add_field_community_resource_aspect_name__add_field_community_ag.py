...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Community.resource_aspect_name'
        db.add_column('clusters_community', 'resource_aspect_name', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Adding field 'Community.agent_geographic_area_name'
        db.add_column('clusters_community', 'agent_geographic_area_name', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Adding field 'CommunityAgent.group'
        db.add_column('clusters_communityagent', 'group', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Adding field 'CommunityAgent.geographic_area'
        db.add_column('clusters_communityagent', 'geographic_area', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'CommunityAgent.region_latitude'
        db.add_column('clusters_communityagent', 'region_latitude', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True), keep_default=False)

        # Adding field 'CommunityAgent.region_longitude'
        db.add_column('clusters_communityagent', 'region_longitude', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True), keep_default=False)

        # Adding field 'Cluster.function_aspect_name'
        db.add_column('clusters_cluster', 'function_aspect_name', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Adding field 'EconomicFunction.aspect'
        db.add_column('clusters_economicfunction', 'aspect', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Adding field 'CommunityResourceType.aspect'
        db.add_column('clusters_communityresourcetype', 'aspect', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Community.resource_aspect_name'
        db.delete_column('clusters_community', 'resource_aspect_name')

        # Deleting field 'Community.agent_geographic_area_name'
        db.delete_column('clusters_community', 'agent_geographic_area_name')

        # Deleting field 'CommunityAgent.group'
        db.delete_column('clusters_communityagent', 'group')

        # Deleting field 'CommunityAgent.geographic_area'
        db.delete_column('clusters_communityagent', 'geographic_area')

        # Deleting field 'CommunityAgent.region_latitude'
        db.delete_column('clusters_communityagent', 'region_latitude')

        # Deleting field 'CommunityAgent.region_longitude'
        db.delete_column('clusters_communityagent', 'region_longitude')

        # Deleting field 'Cluster.function_aspect_name'
        db.delete_column('clusters_cluster', 'function_aspect_name')

        # Deleting field 'EconomicFunction.aspect'
        db.delete_column('clusters_economicfunction', 'aspect')

        # Deleting field 'CommunityResourceType.aspect'
        db.delete_column('clusters_communityresourcetype', 'aspect')
